...
module.exports = async function (req, res, next) {
  ...
  if (req.headers['x-approuter-authorization'].startsWith('Basic')){
    ...
    xssec.createSecurityContext(tokenValue, config, service.type, function (err) {
      if (err) {
        return writeAuditLog(req, tokenValue, `${err.message} - Token validation failed for request url ${req.url}`, 401, tokenDecoded, service.credentials, next);
      } else {
