...
exports.serialize = function (req, name, val, options) {
  ...
  if (req && req.routerConfig && req.routerConfig.cookieBackwardCompatibility) {
    ...
    try {
      ...
      e.message = e.message instanceof String ? e.message : '';
      throw new VError('Illegal character in cookie: cookie %s, you may want to set environment variable ' +
          'COOKIE_BACKWARD_COMPATIBILITY to true for backward compatible validation', e.message.replace('argument ', ''));
    }
  }
};
